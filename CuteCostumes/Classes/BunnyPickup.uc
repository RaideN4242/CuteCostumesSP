class BunnyPickup extends MaskPickup;
...
defaultproperties
{
     ...
     ItemName="HEAD: Bunny Ears"
     ItemShortName="BunnyEars"
     AmmoItemName="7.62mm Ammo"
     AmmoMesh=StaticMesh'KillingFloorStatics.L85Ammo'
     CorrespondingPerkIndex=7
     EquipmentCategoryID=3
     InventoryType=Class'CuteCostumes.BunnyInv'
     PickupMessage="You got Bunny Ears"
