class ElephantInv extends MaskInv;

var	ElephantMask	EleMask;
...
{ 
   local Inventory I;
	...
	if(Role==ROLE_Authority)
	{
		if(EleMask == none)
		{
			EleMask = Spawn(class'ElephantMask',Other);
			EleMask.TransferActor(Other);
		}
...
defaultproperties
{
     HudImage=Texture'CuteCostumes_T.Elephant_trader'
     SelectedHudImage=Texture'CuteCostumes_T.Elephant_trader'
     Weight=0.000000
     TraderInfoTexture=Texture'CuteCostumes_T.Elephant_trader'
     FireModeClass(0)=Class'KFMod.NoFire'
     FireModeClass(1)=Class'KFMod.NoFire'
     SelectForce="SwitchToAssaultRifle"
     bCanThrow=False
     Description="Costume: Elephant Hat."
     Priority=1
     InventoryGroup=5
     GroupOffset=5
     PickupClass=Class'CuteCostumes.ElephantPickup'
     BobDamping=6.000000
     AttachmentClass=Class'CuteCostumes.CostumeAttachment'
     IconCoords=(X1=250,Y1=110,X2=330,Y2=145)
     ItemName="Elephant Mask"
     DrawType=DT_None
