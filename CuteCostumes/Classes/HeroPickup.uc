class HeroPickup extends MaskPickup;
...
defaultproperties
{
     ...
     ItemName="HEAD: Heroes Mask"
     ItemShortName="Heroes Mask"
     AmmoItemName="7.62mm Ammo"
     AmmoMesh=StaticMesh'KillingFloorStatics.L85Ammo'
     CorrespondingPerkIndex=7
     EquipmentCategoryID=3
     InventoryType=Class'CuteCostumes.HeroInv'
     PickupMessage="You got a Hero Mask"
