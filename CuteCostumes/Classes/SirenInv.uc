class SirenInv extends MaskInv;

var		SirenMask		SiMask;
...
{ 
   local Inventory I;
	...
	if(Role==ROLE_Authority)
	{
		if(SiMask == none)
		{
			SiMask = Spawn(class'SirenMask',Other);
			SiMask.TransferActor(Other);
		}
...
defaultproperties
{
     HudImage=Texture'CuteCostumes_T.Siren_trader'
     SelectedHudImage=Texture'CuteCostumes_T.Siren_trader'
     Weight=0.000000
     TraderInfoTexture=Texture'CuteCostumes_T.Siren_trader'
     FireModeClass(0)=Class'KFMod.NoFire'
     FireModeClass(1)=Class'KFMod.NoFire'
     SelectForce="SwitchToAssaultRifle"
     bCanThrow=False
     Description="Costume: Siren Mask."
     Priority=1
     InventoryGroup=5
     GroupOffset=5
     PickupClass=Class'CuteCostumes.SirenPickup'
     BobDamping=6.000000
